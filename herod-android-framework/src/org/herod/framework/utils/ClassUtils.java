...
public abstract class ClassUtils {
	...
	public static Class<?> forName(String className) {
		try {
			...
			throw new ClassException(StringUtils.join("Class", className,
					"is not found."), e);
		}
	}
	...
	public static Field findField(Class<?> clazz, String fieldName) {
		try {
			...
			throw new ClassException(StringUtils.join("Find field", fieldName,
					"from", clazz.getName() + " failed "), e);
	...
	public static Method findMethod(Class<?> clazz, String methodName,
		...
		try {
			...
			throw new ClassException(StringUtils.join("Find method",
					methodName, "from", clazz.getName() + " failed "), e);
